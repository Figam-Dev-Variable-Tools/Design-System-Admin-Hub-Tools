...
- 입력: 계약 30종 · FS 14건 · 테스트 파일 94개 · 스토리 파일 40개
- **단언을 가진 실행 단위(= 테스트): 970건** / 단언 없는 실행 단위: 2건
...
| 2 | 계약 states 커버리지 (contracts/*.contract.json → states[]) | **blocker** | 96 | 96 | 0 | 미커버 상태 0건 (전수) | G5·G6 | PASS |
