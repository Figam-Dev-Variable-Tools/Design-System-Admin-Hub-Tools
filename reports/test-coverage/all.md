...
- 입력: 계약 18종 · FS 14건 · 테스트 파일 83개 · 스토리 파일 28개
- **단언을 가진 실행 단위(= 테스트): 852건** / 단언 없는 실행 단위: 2건
...
| 2 | 계약 states 커버리지 (contracts/*.contract.json → states[]) | **blocker** | 54 | 54 | 0 | 미커버 상태 0건 (전수) | G5·G6 | PASS |
...
|---|---|---|---|---|
| @tds/admin | `apps/admin` | **594** | 0 | PASS |
| @tds/ui | `packages/ui` | **195** | 2 | PASS |
