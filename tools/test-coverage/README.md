...
- `reports/test-coverage/tmp/<scope>-escalations.json` — `handoff.v1` 봉투 (차단 시. → A30·A33·A40·A85·A42·A00). **gitignore** 되는 failure-only 실행 산출물 (매 실행 재현 가능하므로 커밋 기준선이 아니다)
