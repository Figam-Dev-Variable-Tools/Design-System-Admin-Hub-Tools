/**
 * @tds/test-coverage — 커버리지 5축 대조 진입점 (A77 Test Coverage Guard)
 *
 * 실행:
 ...
 *
 * A77은 테스트를 대신 쓰지 않는다 (A30/A40/A85의 일). 검증 대상은 전부 읽기 전용이다.
 */
