...
const CHOICES: readonly { kind: TemplateKind; note: string }[] = [
  ...
  {
    kind: 'email',
    note: '제목과 블록(제목·본문·버튼·이미지)으로 본문을 조립해요.',
  },
  {
    kind: 'alimtalk',
    note: '정보성 메시지. 카카오 사전 심사(영업일 2일)를 받아야 발송할 수 있고 광고는 넣을 수 없어요. 본문은 버튼명을 합쳐 1,000자까지.',
  },
  {
    /*
     ...
     */
    kind: 'brandmessage',
    note: '광고성 메시지를 보낼 수 있어요. 사전 심사가 없는 대신 08:00~20:50 에만 발송돼요. (친구톡은 2025-12-31 종료되어 브랜드 메시지로 대체되었어요.)',
  },
];
