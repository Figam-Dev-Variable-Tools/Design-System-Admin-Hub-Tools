...
const CASE_SEED: readonly CaseStudy[] = [
  ...
  },
  {
    ...
    industry: 'retail',
    client: '벨라마켓',
    challenge: '온·오프라인 재고와 고객 데이터가 단절돼 있었어요.',
    solution: '통합 주문·재고 시스템과 멤버십을 연결했어요.',
  ...
  },
  {
    ...
    industry: 'finance',
    client: '한결저축은행',
    challenge: '지점 창구 혼잡으로 고객 대기시간이 길었어요.',
    solution: '영상 상담 창구와 사전 서류 검증을 도입했어요.',
  ...
  },
  {
    ...
    industry: 'public',
    client: '새빛시청',
    challenge: '민원 접수 채널이 분산돼 처리 현황을 알기 어려웠어요.',
    solution: '단일 포털과 처리 단계 알림을 제공했어요.',
