...
| 판정 기준일 | **2026-07-17 · `HEAD = 4b805ad`** (F3a·F3b·통합 머지 후 — PR #8·#11·#12·#14·#16). 이전 판정은 F2(`3cd3078`) 기준이었고 **COMP-10 · IA-13 · ERP-09 · ERP-13 이 뒤집혔다**(§2 · §3 · §5). **E2E 미실행 — 판정 근거는 전부 코드 대조다**(§6) |
