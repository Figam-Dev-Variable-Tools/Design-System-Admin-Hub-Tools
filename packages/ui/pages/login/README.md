...
| 모듈 | 분류 | 계약 | 비고 |
|---|---|---|---|
| TextField | 신규(잠정) — A75 판정 대기 | 없음 — G3 계약 작성 전 | 이메일 입력 + 비밀번호 입력(표시/숨김 토글 내장) |
| Checkbox | 신규(잠정) — A75 판정 대기 | 없음 — G3 계약 작성 전 | '이메일 저장' |
| Alert | 신규(잠정) — A75 판정 대기 | 없음 — G3 계약 작성 전 | 로그인 실패 · 계정 잠금 · 서버 오류 · 세션 만료 안내 |
